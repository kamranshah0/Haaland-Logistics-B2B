<x-app-layout>
    ...
    <div class="space-y-6" x-data="{ 
        ...
        <div class="space-y-8 animate-fade-in-up" style="animation-delay: 0.1s">
            @forelse($rates as $originId => $originRates)
                @php $origin = $originRates->first()->origin; @endphp
                <div class="premium-card !p-0 overflow-hidden shadow-md">
                    <div class="p-6 border-b border-slate-100 flex justify-between items-center bg-brand-900 text-white">
                        <div class="flex items-center gap-3">
                            <div class="w-10 h-10 bg-white/10 rounded-xl flex items-center justify-center font-bold text-white shadow-inner">
                                {{ $origin->code }}
                            </div>
                            <div>
                                <h3 class="text-lg font-bold font-outfit uppercase tracking-wider">{{ $origin->name }} Routes</h3>
                                <p class="text-[10px] text-brand-300 font-medium uppercase tracking-widest">Origin Center</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr class="bg-slate-50 text-slate-500 text-[10px] uppercase tracking-widest font-bold">
                                    ...
                                    <th class="px-6 py-4">Freight Cat.</th>
            ...
            @empty
                <div class="premium-card py-20 text-center border-2 border-dashed border-slate-200 text-slate-400">
                    <p class="font-bold uppercase tracking-widest text-sm">No shipping rates defined yet.</p>
                </div>
            @endforelse
        </div>
